    ...
    return (
        <div className="flex">
            {items.map((item) => (
                ...
                >
                    <Button size="sm" className="rounded-lg px-1.5 py-1.5 text-slate-600 hover:text-slate-800 hover:bg-slate-100 transition-all duration-200" variant="ghost" type="button">
                        <item.icon
