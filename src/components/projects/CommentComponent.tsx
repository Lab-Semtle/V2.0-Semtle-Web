...
export default function CommentComponent({ projectId }: CommentComponentProps) {
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="font-semibold text-slate-900">{comment.user.nickname}</span>
                                                        ...
                                                        <div key={reply.id} className="flex gap-3">
                                                            ...
                                                            <div className="flex-1">
                                                                <div className="flex items-center gap-2 mb-1">
                                                                    <span className="font-semibold text-slate-900 text-sm">{reply.user.nickname}</span>
